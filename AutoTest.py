...
class Joy188Test(unittest.TestCase):
    ...
    def test_PcLogin(source='Pc'):
        ...
        if env_[0] in ['dev02','dev03','fh82dev02','88hlqpdev02']:# 多增加合營
            password = b'123qwe'
    ...
    def admin_login():
        ...
        admin_cookie = {}
        if env_[0] in['dev02','fh82dev02','88hlqpdev02']:
