...
document.writeln("          <a class=\'dropdown-item\' href=\'otpauth\'>otp驗證碼</a>");
document.writeln("        </div>");
document.writeln("    </div>");
document.writeln("    <div class=\'btn-group\'>");
...
document.writeln("    </div>");
document.writeln("    <div class=\'btn-group\'>");
document.writeln("        <button type=\'button\' class=\'btn btn-secondary\'  onclick=location.href=\'/monitor\'>");
document.writeln("          網域測通");
document.writeln("        </button>");
document.writeln("    </div>");
// document.writeln("    <div class=\'btn-group\'>");
